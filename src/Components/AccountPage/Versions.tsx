    ...
    <div style={{ overflow: "hidden", borderRadius: "10px" }}>
      <StyledVersions>
        ...
        <StyledVersionText>
          ...
          другого устройства или браузера
        </StyledVersionText>
        <StyledVersionText>
          Теперь вы можете сами выбирать цвета для фона
        </StyledVersionText>
        <StyledVersionNumber>0.2.2</StyledVersionNumber>
        <StyledVersionText>Оптимизация работы приложения</StyledVersionText>
        <StyledVersionText>
          Исправлена опечатка в истории версий
        </StyledVersionText>
        <StyledVersionText>Исправлены визуальные ошибки</StyledVersionText>
        <StyledVersionNumber>0.2.1</StyledVersionNumber>
        <StyledVersionText>Настроена мобильная версия</StyledVersionText>
        <StyledVersionText>
        ...
        <StyledVersionText>Изменена схема хранения данных</StyledVersionText>
        <StyledVersionText>Добавлен раздел "другие задачи"</StyledVersionText>
        <StyledVersionText>
          Длинные тесты задач показываются полностью
        </StyledVersionText>
        <StyledVersionNumber>0.0.1</StyledVersionNumber>
        <StyledVersionText>Первое размещение в интернете</StyledVersionText>
        <StyledVersionText>
